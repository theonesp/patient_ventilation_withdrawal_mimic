...
write.csv(cohort_with_propofol_infusion_epoch,'cohort_with_propofol_infusion_epoch.csv',row.names = F)
```
...
write.csv(cohort_with_propofol_bolus_epoch,'cohort_with_propofol_bolus_epoch.csv',row.names = F)
```
...
# midazolam =  1 milligram of morphine IV (225154) is equivalent to .01 mg Fentanyl IV (221744).
...
write.csv(cohort_with_midazolam_infusion_epoch,'cohort_with_midazolam_infusion_epoch.csv',row.names = F)
```
...
write.csv(cohort_with_midazolam_bolus_epoch,'cohort_with_midazolam_bolus_epoch.csv',row.names = F)
```
...
write.csv(cohort_with_lorazepam_infusion_epoch,'cohort_with_lorazepam_infusion_epoch.csv',row.names = F)
```
...
write.csv(cohort_with_lorazepam_bolus_epoch,'cohort_with_lorazepam_bolus_epoch.csv',row.names = F)
```
...
write.csv(cohort_with_dexmedetomedie_infusion_epoch,'cohort_with_dexmedetomedie_infusion_epoch.csv',row.names = F)
```
...
write.csv(cohort_with_dexmedetomedie_bolus_epoch,'cohort_with_dexmedetomedie_bolus_epoch.csv',row.names = F)
```
